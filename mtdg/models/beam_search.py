...
class Beam(object):
    def __init__(self, batch_size, hidden_size, vocab_size, beam_size, max_unroll, batch_position, EOS_ID="3"):
    ...
    def backtrack(self):
        ...
        for t in reversed(range(self.max_unroll)):
            ...
            # [< batch x beam]
            eos_indices = self.token_ids[t].data.eq(self.EOS_ID).nonzero()
            ...
            if eos_indices.dim() > 0:
                ...
                for i in range(eos_indices.size(0) - 1, -1, -1):
                    ...
                    batch_idx = eos_idx.item() // self.beam_size
